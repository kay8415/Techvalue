"""
Electronics Scraper - Cloudflare R2 Version
Scrapes https://www.sheeel.com/ar/electronics.html and all subcategories
...
class ElectronicsScraper:
    def __init__(self, r2_bucket=None, cf_access_key=None, cf_secret_key=None, cf_endpoint_url=None, max_concurrent_subcategories=3):
        self.base_url = "https://www.sheeel.com/ar/electronics.html"
    ...
    async def get_subcategories(self, page):
        ...
        try:
            ...
            for elem in subcategory_elements:
                ...
                if url and name and '/ar/electronics/' in url:
    ...
    async def scrape_all_subcategories(self):
        ...
        print("\n" + "="*70)
        print("🚀 ELECTRONICS SCRAPER - CONCURRENT SUBCATEGORIES")
        print("="*70)
    ...
    def save_to_excel(self, include_r2_paths=False):
        ...
        filename = f"electronics_{timestamp}.xlsx"
    ...
    def upload_results_to_r2(self):
        ...
        # Upload to R2
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        excel_filename = f"electronics_{timestamp}.xlsx"
    ...
    def run(self):
        ...
        print("\n" + "="*70)
        print("📱 ELECTRONICS SCRAPER - CLOUDFLARE R2 (CONCURRENT)")
        print("="*70)
