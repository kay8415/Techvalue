"""
Mobile & E-Cards Scraper - Cloudflare R2 Version
Scrapes https://www.sheeel.com/ar/mobiles-e-cards.html and all subcategories
...
class MobileECardsScraper:
    def __init__(self, r2_bucket=None, cf_access_key=None, cf_secret_key=None, cf_endpoint_url=None, max_concurrent_subcategories=3):
        self.base_url = "https://www.sheeel.com/ar/mobiles-e-cards.html"
        self.category = "mobile_e_cards"
        ...
        # Setup Cloudflare R2 if credentials provided
    ...
    async def get_subcategories(self, page):
        ...
        try:
            ...
            for elem in subcategory_elements:
                ...
                if url and name and '/ar/mobiles-e-cards/' in url:
    ...
    async def scrape_all_subcategories(self):
        ...
        print("\n" + "="*70)
        print("🚀 MOBILE & E-CARDS SCRAPER - CONCURRENT SUBCATEGORIES")
        print("="*70)
    ...
    def download_all_images(self):
        ...
        for i, product in enumerate(self.all_products, 1):
            ...
            # Store all local and R2 paths as arrays
    ...
    def save_to_excel(self, include_r2_paths=False):
        ...
        filename = f"mobile_e_cards_{timestamp}.xlsx"
        ...
        with pd.ExcelWriter(local_path, engine='openpyxl') as writer:
            ...
            for slug, data in self.subcategories.items():
                ...
                # Remove local_image_paths column if R2 is configured
                if include_r2_paths and 'local_image_paths' in df.columns:
                    df = df.drop(columns=['local_image_paths'])
                
                # Clean ALL cells to remove illegal Excel characters
                try:
    ...
    def upload_results_to_r2(self):
        ...
        # Just create Excel file with R2 paths (multi-sheet)
    ...
    def run(self):
        ...
        print("\n" + "="*70)
        print("📱 MOBILE & E-CARDS SCRAPER - CLOUDFLARE R2 (CONCURRENT)")
        print("="*70)
        ...
        if self.r2_client:
            # Use R2 upload which creates Excel with R2 paths
