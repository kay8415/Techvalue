# Electronics Category Scraper

Automated scraper for the Electronics category on **sheeel.com** with **concurrent subcategory scraping**.
        ...
        └── month=04/
            └── day=14/
                └── electronics/
                    ...
                    │   └── ...
                    └── excel-files/
                        └── electronics_20260414_120000.xlsx
```

### Excel Structure

**Multiple sheets:**
- One sheet per subcategory (e.g., smartphones, laptops, etc.)
...
- `download_all_images()` - Download all product images (sync)
- `save_to_excel()` - Generate multi-sheet Excel file (sync)
- `upload_results_to_s3()` - Upload images & Excel to S3 (sync)
...
# Download Excel file
aws s3 cp s3://{bucket}/sheeel_data/year=2026/month=04/day=14/electronics/excel-files/electronics_*.xlsx .
```
